      ...
      <Container>
        <Row className="align-items-center min-vh-100">
          <Col lg={8} className="mx-auto text-center">
            <h5 className="text-primary fw-bold mb-3 tracking-wide text-uppercase" style={{ letterSpacing: '2px' }}>
              Hello, I'm
            </h5>
            ...
            <h2 className="h3 text-secondary mb-4">
              React Developer <span className="text-muted mx-2">|</span> Frontend Web Developer
            </h2>
            <p className="lead mb-5 px-lg-5 text-muted">
              I specialize in building modular, high-performance web applications with a focus on UI/UX excellence. Over a year of professional experience delivering scalable React-based solutions.
            </p>
            <div className="d-flex justify-content-center gap-3 flex-wrap">
              ...
              <PDFDownloadLink document={<ResumeDownload />} fileName="R_Kannan_Resume.pdf" style={{ textDecoration: 'none' }}>
                {({ loading }) => (
                  <Button 
